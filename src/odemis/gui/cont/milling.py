...
class MillingButtonController:
    ...
    def __init__(self, tab_data, tab_panel):
        ...
        self._panel.gauge_lcl_milling_series.Hide()
        self._panel.txt_lcl_milling_series_left_time.Hide()
        self._panel.txt_lcl_milling_est_time.Show()
        self._panel.btn_lcl_milling_cancel.Hide()
        self._panel.Layout()
        ...
        # for "Cancel" button
        self._panel.btn_lcl_milling_cancel.Bind(wx.EVT_BUTTON, self._cancel_milling_series)
    ...
    def _on_milling_series(self, evt: wx.Event):
        ...
        self._panel.txt_lcl_milling_est_time.Hide()
        self._panel.txt_lcl_milling_series_left_time.Show()
        self._panel.gauge_lcl_milling_series.Show()
        self._panel.btn_lcl_milling_cancel.Show()
        ...
        self._gauge_future_conn = ProgressiveFutureConnector(
            ...
            bar=self._panel.gauge_lcl_milling_series,
            label=self._panel.txt_lcl_milling_series_left_time,
            full=False,)
    ...
    def _on_milling_done(self, future):
        ...
        self._panel.txt_lcl_milling_est_time.SetLabel(milling_status_txt)

    @wxlimit_invocation(1)  # max 1/s
    def _update_milling_time(self):
        """
        Updates the estimated time
        required for millings
        """
        try:
            millings = millmng.load_config(MILLING_SETTINGS_PATH)
        ...
        self._panel.txt_lcl_milling_est_time.SetLabel(txt)
